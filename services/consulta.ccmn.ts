...
export class ConsultaCcmnService {
  ...
  private RESOURCE_REPORTE_RESUMIDO_CCMN: string = environment.urlBaseIntranet + ConstantesApp.RESOURCE_REPORTE_RESUMIDO_CCMN;

  private ccmn: CcmnResumen[] = new Array();
  private reporteresumidoCcmn: reporteresumido[]=new Array();
  private rptCcmnResumen = new BehaviorSubject<any>(this.ccmn);
  public rptCcmnResumen$ = this.rptCcmnResumen.asObservable();
  private reporteCcmnResumen = new BehaviorSubject<any>(this.reporteresumidoCcmn);
  public reporteCcmnResumen$ = this.reporteCcmnResumen.asObservable();
